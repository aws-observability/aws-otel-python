...
if [[ $OTEL_EXPORTER_OTLP_INSECURE ]]; then
    OTEL_EXPORTER_ENV_VARS_CONFIG="$OTEL_EXPORTER_ENV_VARS_CONFIG -e OTEL_EXPORTER_OTLP_INSECURE=$OTEL_EXPORTER_OTLP_INSECURE"
fi

if [[ $OTEL_EXPORTER_OTLP_CERTIFICATE ]]; then
    OTEL_EXPORTER_ENV_VARS_CONFIG="$OTEL_EXPORTER_ENV_VARS_CONFIG -e OTEL_EXPORTER_OTLP_CERTIFICATE=$OTEL_EXPORTER_OTLP_CERTIFICATE"
fi
