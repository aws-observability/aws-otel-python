...
Currently, these components are in preview, tested with [Open Telemetry Python 0.16b1](https://github.com/open-telemetry/opentelemetry-python/releases/tag/v0.16b1).
